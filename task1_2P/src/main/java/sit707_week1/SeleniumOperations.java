...
public class SeleniumOperations {
	...
	public static void open_chrome_and_close() {
		...
		/*
		 * We will use a lot of Selenium APIs here in future including maximise window
		 * and open a URL in chromium browser.
		 */
	...
	public static void open_chrome_loadpage_resize_close() {
	    ...
	    System.out.println("Hello from 223495239, Hashini Gunathilaka");
	    ...
	    // Close chrome driver. You can comment the below line to keep the browser opened.
	    driver.close();
	}
